...
// document.body.innerHTML = '<h1>Hello from Hyperborea</h1>';

// The document object has a ton of methods. One is `document.write()`, which will write something to the document
document.write('Hello from Sumeria');

// We also have methods to select elements more directly
document.getElementById('main').innerHTML = '<h1>Hello from Hyperborea</h1>';

document.querySelector('#main h1').innerText = 'Hello Nigger!';